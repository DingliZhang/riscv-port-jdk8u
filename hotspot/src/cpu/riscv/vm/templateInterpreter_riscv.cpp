...
address InterpreterGenerator::generate_Reference_get_entry(void) {
 ...
 if (UseG1GC) {
  ...
  __ ret();
   ...
   __ bind(slow_path);
   (void) generate_normal_entry(false);  //TODO-RISCV64 Maybe `__ jump_to_entry(Interpreter::entry_for_kind(Interpreter::zerolocals));`?
 ...
 // Reference.get is an accessor
  return generate_accessor_entry();  //TODO-RISCV64, maybe `return NULL;`
}
...
void InterpreterGenerator::bang_stack_shadow_pages(bool native_call) {
  ...
  const int n_shadow_pages = StackShadowPages;
...
//  TODO-RISCV64
...

  {
    ...
    __ addi(t1, zr, (u1)JavaThread::stack_guard_yellow_disabled);
